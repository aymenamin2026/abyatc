export const translations = {
  en: {
    ...
    shipping_address: "Project Location",
...
easy_care_desc: "We provide innovative solutions that meet the needs of our customers and enhance the value of their projects.",
    ...
    shipping_method: "Order Execution Priority",
    ...
    canceled: "Canceled",
    cancelled: "Cancelled",
    in_way:"In Way For You",
    shipped: "Shipped",
    refunded: "Refunded",
    processing: "Approved And Preparing the equipment",
    ...
    no_shipping_methods: "Pleade Select Location First",
    standard_delivery: "Standard delivery",
    loading_payment_options: "Loading payment options...",
    est_delivery: "Estimated Time of Arrival ",
    ...
    address_incomplete: "Please ensure your project address is complete (Name, Address, City required).",
  ...
  ar: {
    ...
    order_items: "معدات الطلب",
    shipping_address: "موقع المشروع ",
    ...
    remove_item_title: "حذف المعدة؟",
    remove_item_confirm: "هل أنت متأكد أنك تريد حذف هذا المعدة من سلة التسوق؟",
    yes_remove: "نعم، حذف",
    ...
    no_products: "لم يتم العثور على معدات.",
    filters: "التصنيفات",
    ...
    no_products_added_desc: "يبدو أنك لم تضف أي معدات إلى سلة تسوقك بعد. استكشف مجموعاتنا لتجد زيك المهني المثالي.",
    ...
    canceled: "الملغاة",
    cancelled: "الملغاة",
    in_way:" في الطريق اليك",
    shipped: "تم الشحن",
    refunded: "مسترجع",
    processing: "تم الاعتماد وجاري تجهيز العده",
    payment_failed: "فشل الدفع",
    view_order: "عرض الطلب",
    order_number: "رقم الطلب",
    estimated_delivery: "التوصيل المتوقع",
    items_count: "{count} معدات",
    ...
    no_shipping_methods: "يرجئ اختيار الموقع اولا",
    standard_delivery: "توصيل قياسي",
    loading_payment_options: "جاري تحميل خيارات الدفع...",
    est_delivery: "الوقت المتوقع لوصول المعدة",
    ...
    address_incomplete: "يرجى التأكد من اكتمال عنوان موقع المشروع الخاص بك (الاسم، العنوان، المدينة مطلوبة).",
    ...
    results: "نتائج",
    loading_products: "جاري تحميل المعدات...",
    apparel: "ملابس",
   ...
   // privacy: "سياسة الخصوصية",
    faq: "الأسئلة الشائعة",
    related_products: "معدات ذات صلة",
    ...
    wishlist_empty_desc: "تصفح معداتنا وأضف المفضلة لديك هنا لتتبع المعدات التي تحبها.",
    added_to_wishlist: "تمت الإضافة للمفضلة",
    removed_from_wishlist: "تمت الإزالة من المفضلة",
    login_to_wishlist: "يرجى تسجيل الدخول لإضافة معدات إلى المفضلة",
    browse_products: "تصفح المعدات",
  }
};
